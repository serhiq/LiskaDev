...
class ManualSortFragment :Fragment(), ItemDragListenerManual {

    private lateinit var viewModel: ManualSortViewModel
    private lateinit var listRv: RecyclerView
    private lateinit var coordinatorLayout: CoordinatorLayout
    private lateinit var itemTouchHelper: ItemTouchHelper

    lateinit var  adapter : ManualSortAdapter
    ...
    private fun setupContainerFragmentUi() {
        ...
        val title = requireContext().getString(R.string.title_sort_list)
    ...
    private fun setupObservers() {
        viewModel.lists.observe(viewLifecycleOwner, Observer {
            it?.let {
                ...
                adapter=ManualSortAdapter(it.toMutableList(),this)
    ...
    private fun setupViewModel() {
        ...
        viewModel = ViewModelProvider(this, viewModelFactory)[ManualSortViewModel::class.java]
    }
    ...
    private fun navigateToBack() {
        ...
        viewModel.runBackAndSaveSorted(sortedList)
    }
